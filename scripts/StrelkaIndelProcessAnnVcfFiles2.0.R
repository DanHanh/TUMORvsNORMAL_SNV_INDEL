...
## remove later
#Path <- paste0("./../testing/Strelka/VEP/")
#InputFile <- "Strelka_104908-001-002_vs_104908-001-001_somatic_snvs_VEP.ann.vcf.gz"
#outputFile <- paste0("Mutations_Strelka_snvs","_104908", "_VEP.ann.xlsx")
